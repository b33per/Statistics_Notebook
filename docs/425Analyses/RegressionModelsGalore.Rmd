...
ggplot(mtcars, aes(x = disp, y = qsec, color = factor(am))) +
  ...
  stat_function( fun = function(x) (b[1] + b[4]) + (b[2] + b[5])*x + (b[3] + b[6])*x^2, color= "orange")+
...
ggplot(fabData, aes(x = x, y = y, color = equation)) +
  ...
  stat_function(fun = function(x) beta0.1 + beta1.1*x + beta2.1*x^2, color = "firebrick", linetype = "dashed", size = 1) + 
  
  stat_function(fun = function(x) beta0.2 + beta1.2*x + beta2.2*x^2, color = "midnightblue", linetype = "dashed", size = 1) + 
  
   stat_function(fun = function(x)  b1[1] + b1[2]*x + b1[3]*x^2,, color = "firebrick", linetype= "solid", size = 1)+ 
  
  stat_function(fun = function(x) b2[1] + b2[2]*x + b2[3]*x^2, color = "midnightblue", linetype = "solid", size = 1) +
