...
If the requirements listed above are satisfied, then the results of the test can be trusted to give meaningful inference about the population. If the requirements are not met, then that doesn't mean the results of the test are necessarily bad, but there is no guarantee that they are good.
...
**Examples**: [analysis resubmits](./325Analyses/t Tests/Examples/Math325AnalysisResubmits.html)
...
**Examples**: [sleepPaired](./325Analyses/t Tests/Examples/SleepPairedt.html) [studentPaired](./325Analyses/t Tests/Examples/Student1Paired.html)
...
**Examples**: [sleepInd](./325Analyses/t Tests/Examples/SleepIndependentt.html) [student1](./325Analyses/t Tests/Examples/Student1Independent.html) [student2](./325Analyses/t Tests/Examples/Student2Independent.html)
