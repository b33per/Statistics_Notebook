...
set.seed(101) #Allows us to always get the same "random" sample
  ...
  X_i <- runif(n, 0, 22) #Gives n random values from a uniform distribution between 15 to 45.
...
<div style="padding-left:125px;">
**Examples:** [bodyweight](./325Analyses/Linear Regression/Examples/BodyWeightSLR.html), [cars](./325Analyses/Linear Regression/Examples/carsSLR.html) 
</div>
...
This helps us see how the two groups are different from each other.
...
<div style="padding-left:125px;">
**Examples:** [Civic Vs Corolla](./325Analyses/Linear Regression/Examples/CivicVsCorollaMLR.html) [cadillacs](./325Analyses/Linear Regression/Examples/cadillacsMLR.html) 
</div>
